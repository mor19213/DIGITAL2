# 1 "C:/Users/danie/OneDrive/Desktop/DIGITAL2/proyecto2/master.X/I2C.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "C:/Users/danie/OneDrive/Desktop/DIGITAL2/proyecto2/master.X/I2C.c" 2
...
signed short ADXL345_readX(void){
     ...
     int16_t accel_x;
     signed short acc_x;
     data_x[0] = ADXL345_READ(0x32);
     data_x[1] = ADXL345_READ(0x33);
...
signed short ADXL345_readY(void){
     ...
     int16_t accel_y;
     signed short acc_y;
     data_y[0] = ADXL345_READ(0x34);
     data_y[1] = ADXL345_READ(0x35);
...
signed short ADXL345_readZ(void){
     ...
     int16_t accel_z;
     signed short acc_z;
     data_z[0] = ADXL345_READ(0x36);
     data_z[1] = ADXL345_READ(0x37);
